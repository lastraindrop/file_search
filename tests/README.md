...
| 层次 | 模块/文件 | 测试数 | 覆盖范围 |
|------|-----------|--------|----------|
| **v6.5.0 全量回归** | `test_v8_comprehensive.py` | 77 | DI/DI反转/OOM保护/CLI search+export/ProcessManager/完整回归 |
...
| **v6.4.0 BUG修复** | `test_bugfix_v7.py` | 83 | BUG修复/GlobalSettings/PathValidator/DI/格式工具/搜索 |
| **v6.3.3 BUG修复** | `test_bugfix_v633.py` | 22 | is_truncated/CDATA/CORS/NoiseReducer/version |
| **v6.3.2 回归** | `test_bugfix_v632.py` | 53 | CLI分支/配置API/搜索/路径/文件/噪声/DI |
